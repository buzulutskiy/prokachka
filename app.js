...
const BOOK_ACH = { "snow-1": ACH_BOOK, odyssey: ACH_ODYSSEY, tesson: ACH_TESSON };
const BOOK_WORDS = { "snow-1": WORDS_BOOK, odyssey: WORDS_ODYSSEY, tesson: WORDS_TESSON };
...
const FACTS = {
  ...
  "snow-1": [
    ...
    { t: "Волчок и вечное яблоко",
      ...
      more: ["В фильме звучит «Утомлённое солнце», Бах и Моцарт — музыка работает как память",
             "Название взято из стихотворения Назыма Хикмета — стоит прочитать целиком"] },
    ...
    { t: "Книга выросла из живых занятий",
      x: "В основе — лекции, прочитанные студентам в Токио осенью 1994 года и на Высших курсах сценаристов и режиссёров ещё в конце 1980-х; частями они печатались в журнале «Искусство кино». Отсюда её разговорная интонация: это не трактат, а записанная речь. Читать её лучше кусками, как слушают лекцию.",
      more: ["Номера «Искусства кино» с этими главами есть в открытом архиве журнала",
             "Есть видеозаписи его мастер-классов — полезно услышать интонацию"] },
    { t: "Туман сделан из пыли и стекла",
      x: "Норштейн с оператором Александром Жуковским собрали собственный съёмочный станок с несколькими ярусами стекла: персонажа снимали через слои, которые то приближали, то отдаляли от камеры. Туман получался из пыли, нанесённой на прозрачную плёнку, — приём, восходящий к старому восточному театру теней. Волшебство здесь — точный технический расчёт.",
      more: ["Поищи фотографии станка Норштейна — конструкция выглядит как самодельная машина",
             "Про принцип многослойной съёмки хорошо рассказывают документальные фильмы о студии"] },
    { t: "Ёжика рисовала Франческа Ярбусова",
      ...
      more: ["Найди эскизы Ярбусовой к «Ёжику» — видно, каким он мог быть",
             "Её альбомы к «Шинели» — отдельное сильное впечатление"] },
    { t: "Признан лучшим мультфильмом всех времён",
    ...
    { t: "«Шинель» снимается больше сорока лет",
      x: "Фильм по повести Гоголя Норштейн начал в 1981 году и не закончил до сих пор; сценарий он писал вместе с Людмилой Петрушевской. У незавершённой работы уже есть награды — по показанным фрагментам. Это крайняя форма его же принципа: важнее сделать точно, чем закончить в срок.",
      more: ["Фрагменты «Шинели» иногда показывают на его вечерах — стоит попасть",
             "Повесть Гоголя перед этим лучше перечитать"] },
    { t: "Техника называется перекладка",
      x: "Его персонажи — не рисунки на плёнке и не куклы, а плоские фигурки из бумаги с подвижными частями, которые двигают под камерой по кадру. Отсюда особая пластика: движение чуть неровное, живое, с сопротивлением материала. Ограничение техники становится характером фильма.",
      more: ["Поищи слово «перекладка» (cut-out animation) — приём старше рисованной анимации",
             "Ранние опыты Лотты Райнигер с силуэтами — предок этой техники"] },
    { t: "Государственная премия за «Ёжика»",
    ...
    { t: "Он говорит о литературе не меньше, чем о рисунке",
    ...
    { t: "Кадр строится, как картина",
      ...
      more: ["Открой альбом Рембрандта и найди, куда падает свет на лицах",
             "У Норштейна много о Ван Гоге — стоит смотреть параллельно с чтением"] },
    { t: "Медленно — это метод, а не беда",
      x: "Его фильмы делались годами: десять минут экранного времени могли занять несколько лет работы. Норштейн отказывается ускоряться, потому что считает, что образ должен вызреть. В книге он объясняет это спокойно, без позы мученика — просто такова цена точности.",
      more: ["Сравни: «Ёжик» — 10 минут, «Сказка сказок» — около 29",
             "Посчитай, сколько кадров в минуте перекладки — цифра отрезвляет"] },
    { t: "Он не считает свои фильмы детскими",
      ...
      more: ["Покажи «Ёжика» ребёнку и послушай, что он скажет о тумане",
             "У Козлова в сказках та же интонация разговора на равных"] },
    { t: "Память как материал",
      x: "Главный источник его образов — собственное детство: коммунальный двор, послевоенная Москва, соседи. Он превращает частное воспоминание в общее, не объясняя его. Поэтому зритель, не живший в том дворе, всё равно узнаёт своё.",
      more: ["Посмотри «Сказку сказок» и запиши, какие три кадра остались с тобой",
             "Норштейн рассказывает об этом дворе и в книге, и в интервью"] },
    { t: "Свет он ставит, как в театре",
      x: "В перекладке свет нельзя нарисовать — его ставят физически, лампами, и он проходит через ярусы стекла. Отсюда тёплое свечение, которое невозможно повторить фильтром. Ограничение снова оказывается автором стиля.",
      more: ["Присмотрись к свету в сцене с лошадью в тумане — он объёмный",
             "Про световые решения он подробно говорит в главах о съёмке"] },
    { t: "Книга издана в двух томах",
      x: "«Снег на траве» вышла как двухтомник с большим количеством иллюстраций, эскизов и раскадровок. Она устроена как альбом: текст и изображение читаются вместе. Поэтому пролистывать её быстро бессмысленно — она рассчитана на медленное чтение.",
      more: ["Открой раскадровки и попробуй прочитать их как комикс",
             "Второй том во многом посвящён «Шинели»"] },
    { t: "Зачем ему было всё это объяснять",
      x: "Норштейн говорит, что делает эти лекции, потому что ремесло передаётся только из рук в руки, а книга — попытка растянуть этот разговор во времени. Он не даёт рецептов, он показывает ход мысли. Чтение такой книги ближе к ученичеству, чем к получению информации.",
  ...
  if (item.track === "book") {
    ...
    return `
      <div class="cover book ${esc(b.tone || "sea")}">
        ...
        ${b.art === "wave" ? SEA_ART : b.art === "pine" ? PINE_ART : `<div class="cv-mark">🦔</div>`}
        <div>
  ...
  return `
    ${next
      ? `<div class="facts-note">${byPage
          ? `Прочитано до <b>${step}</b>-й страницы. Следующая карточка ждёт на <b>${next.need}</b>-й — карточки идут за песнями, каждая открывается, когда песнь дочитана.`
