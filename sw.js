const CACHE = "prokachka-v76";
const SHELL = ["./", "./index.html", "./app.js", "./manifest.webmanifest", "./covers/screwtape.jpg", "./covers/unizhennye.jpg", "./covers/snow.jpg", "./covers/odyssey.jpg", "./covers/tesson.jpg", "./icon-192.png", "./icon-512.png"];
